...
class ServidorOperacion {
    public static void main(String[] args) {
        try (ServerSocket serverSocket = new ServerSocket(5001, 50, InetAddress.getByName("10.147.19.224"))) {
...
class ManejadorOperacion implements Runnable {
    ...
    public void run() {
        try (DataInputStream in = new DataInputStream(socket.getInputStream());
            ...
            System.out.println(" Recibí el valor: " + valor + " de " + socket.getInetAddress().getHostAddress());
